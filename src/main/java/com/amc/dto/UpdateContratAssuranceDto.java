...
@Data
public class UpdateContratAssuranceDto {
    ...
    @NotBlank(message = "Le code de durée ne peut être nul ou vide")
    private String codedure;
    private Integer valedure;
    @NotBlank(message = "L'unité de durée ne peut être nulle ou vide")
    private String unitdure;
    @NotBlank(message = "La valeur de durée ne peut être nulle ou vide")
